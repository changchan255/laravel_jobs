                ...
                <div class="btns-profiles-sec">
                    ...
                    <ul>
                        @foreach(config('user.drop_menu') as $item)
                            <li><a href="{{ route($item['route']) }}" title=""><i class="{{ $item['icon'] }}"></i>{{ $item['name'] }}</a></li>
                        @endforeach
                        <li><a href="{{ route('get_user.update_password.index') }}" title=""><i class="la la-lock"></i>Cập nhật mật khẩu</a></li>
